...
@ViewChild('SelectColorBG') InputColor: ElementRef;
SetColor(){
  var color = this.InputColor.nativeElement.value;
  // var color = document.getElementById("SelectColorBG").value;
...
console.log("err");
  ...
  async CargarCurso()
  {
    ...
    // var Agrupacion:any = await this.AgruparCurso('SUPERIOR'); this.intermediosuperior = Agrupacion;
    // var Agrupacion:any = await this.AgruparCurso('SUPERIOR'); this.superior = Agrupacion;
  //   var Agrupacion:any = await this.AgruparCurso('PRIMERO BASICO'); this.curso1roB = Agrupacion;
  //   var Agrupacion:any = await this.AgruparCurso('SEGUNDO BASICO'); this.curso2doB = Agrupacion;
  //   var Agrupacion:any = await this.AgruparCurso('TERCERO BASICO'); this.curso3roB = Agrupacion;
  //   var Agrupacion:any = await this.AgruparCurso('PRIMERO MEDIO');  this.curso1roM = Agrupacion;
  //   var Agrupacion:any = await this.AgruparCurso('SEGUNDO MEDIO');  this.curso2doM = Agrupacion;
  //   var Agrupacion:any = await this.AgruparCurso('TERCERO MEDIO');  this.curso3roM = Agrupacion;
  //  var Agrupacion:any = await this.AgruparCurso('PRIMERO SUPERIOR');this.curso1roS = Agrupacion;
  //  var Agrupacion:any = await this.AgruparCurso('SEGUNDO SUPERIOR');this.curso2doS = Agrupacion;
  //  var Agrupacion:any = await this.AgruparCurso('TERCERO SUPERIOR');this.curso3roS = Agrupacion;
    // console.log('AGRUPACION',await this.AgruparCurso('PRIMERO SUPERIOR'));
  }
  async AgruparCurso() {
  ...
  AgregarDocenteCurso(event, itemCurso)
  {
    ...
    else
    {
      ...
      axios.post(this.ruta+'api/EliminarAdminCursos/', {
        curso_id: CursoID,
        admin_id: AdminID
      })
